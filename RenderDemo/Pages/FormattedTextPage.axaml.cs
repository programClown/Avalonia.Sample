    ...
    public partial class FormattedTextPage : UserControl
    {
        ...
        public override void Render(DrawingContext context)
        {
            ...
            var formattedText = new FormattedText(
                ...
                32,
                Brushes.Black)
            { MaxTextWidth = 300, MaxTextHeight = 240 };

            // Set a maximum width and height. If the text overflows these values, an ellipsis "..." appears.

            // Use a larger font size beginning at the first (zero-based) character and continuing for 5 characters. The
            // font size is calculated in terms of points -- not as device-independent pixels.
